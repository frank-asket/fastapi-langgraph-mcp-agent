...
export function HeroDashboardMockup() {
  return (
    <div className="relative mx-auto max-w-xl">
      <div
        className="sc-landing-glow pointer-events-none absolute -inset-x-8 -bottom-6 top-1/4 rounded-[2rem] bg-sc-lime/20 blur-3xl"
        aria-hidden
      />
      <div className="relative overflow-hidden rounded-2xl border border-sc-line bg-sc-elev/95 shadow-2xl ring-1 ring-sc-lime/10 backdrop-blur-sm">
        <div className="flex items-center gap-2 border-b border-sc-line bg-sc-surface/80 px-4 py-3">
          <span className="h-2.5 w-2.5 rounded-full bg-red-400/80" />
          <span className="h-2.5 w-2.5 rounded-full bg-amber-400/80" />
          <span className="h-2.5 w-2.5 rounded-full bg-sc-lime/80" />
        ...
        <div className="space-y-4 p-5 sm:p-6">
          <p className="font-[family-name:var(--font-syne)] text-lg font-bold text-white">
            Hello <span className="text-sc-lime">Ama</span> <span aria-hidden>👋</span>
          </p>
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            {[
              ...
              <div
                key={c.t}
                className="rounded-xl border border-sc-line bg-sc-bg/80 px-3 py-3 transition duration-300 hover:border-sc-lime/35 hover:shadow-[0_0_0_1px_rgba(200,245,61,0.12)]"
              >
          ...
          <div className="rounded-xl border border-dashed border-sc-lime/25 bg-sc-lime/[0.04] px-4 py-3">
            <p className="text-[0.7rem] font-semibold uppercase tracking-wider text-sc-lime/90">Next step</p>
